 ...
 * @returns Parse tree
 */
function parseAST(processedText) {
...
function lineMap(line) {
    ...
    return map;
    function currentLineASTExtract(gotOne) {
        tempCounter += 1;
