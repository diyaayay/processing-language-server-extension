 ...
 */
// from extension host
let startEncountered;
let settingsSet = new Set();
function pipeLine(refactorCode) {
 ...
 */
function addExplicitAccessModifier(line) {
 ...
 */
function removeSingleComment(line) {
 ...
 */
function removeBlockComment(line) {
 ...
 */
function addFloatingIndicator(line) {
 ...
 */
function extractEnvironmentCalls(line) {
 ...
 */
function addSettingsFunction() {
    let settingsContext = ``;
    let index = 0;
    settingsSet.forEach(function (setting) {
 ...
 */
function convertCastingCalls(processText) {
...
//# sourceMappingURL=codeRefactoring.js.map