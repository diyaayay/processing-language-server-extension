...
copy %cwd%\server\src\processing\jar\core-new.jar    %cwd%\server\out\processing\extractor 1>nul
echo Copied \server\src\processing\jar\core-new.jar to \server\out\processing\extractor
copy %cwd%\server\src\processing\jar\core-new.jar    %cwd%\pcore 1>nul
echo Copied \server\src\processing\jar\core-new.jar to \pcore
...
echo Unpacking: %cwd%\server\out\processing\extractor\core-new.jar
jar xf %cwd%\server\out\processing\extractor\core-new.jar
del core-new.jar
cd %cwd%\pcore
echo Unpacking: %cwd%\pcore\core-new.jar
jar xf %cwd%\pcore\core-new.jar
del core-new.jar
